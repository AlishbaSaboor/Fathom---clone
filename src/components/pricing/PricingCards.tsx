...
/**
 * Three plan cards. Free links straight into the real app. Pro and Plus are
 * plausible marketing copy for a paid tier that doesn't exist yet, so their
 * buttons show the same honest stub message as the rest of the app.
 *
 * TODO once real accounts exist: gate Pro/Plus behind a "log in first" check
 * instead of this stub message. Not building that yet, per instructions.
 */
