...
export function PrivacyPolicyModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <Modal open={open} onClose={onClose} title="Privacy Policy">
      <div className="max-h-[65vh] space-y-4 overflow-y-auto pr-1 text-sm leading-relaxed text-[#201D1A]/80 dark:text-[#F3F4F6]/80">
        <p>
          <strong className="font-semibold text-[#201D1A] dark:text-[#F3F4F6]">What we collect.</strong> Your name and
        ...
        <p>
          <strong className="font-semibold text-[#201D1A] dark:text-[#F3F4F6]">How recordings are processed and
        ...
        <p>
          <strong className="font-semibold text-[#201D1A] dark:text-[#F3F4F6]">Sharing.</strong> A recording&rsquo;s
        ...
        <p>
          <strong className="font-semibold text-[#201D1A] dark:text-[#F3F4F6]">Your control.</strong> You can delete
